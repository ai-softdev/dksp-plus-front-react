...
const Footer = () => {
    ...
    return (
        <footer className={'bg-cloudburst py-12'}>
            <div className="container">
                <div className={'w-full flex items-center justify-between pb-14 border-b border-dusk'}>
                    <div className={'flex items-center gap-3 text-xl text-cloudburst'}>
                        ...
                        <span className={'font-black text-whitesmoke'}>
                            DKSP PLUS
                        </span>
                    </div>
                    <div className={'flex items-center gap-10'}>
                        ...
                        <SocialItem
                            svg={<svg xmlns="http://www.w3.org/2000/svg" width="69" height="68" viewBox="0 0 69 68" fill="none">
                                <circle cx="34.2988" cy="34" r="34" fill="#FFB342"/>
