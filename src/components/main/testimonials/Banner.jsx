    ...
    return (
        <div className={'bg-butterscotch p-10'}>
            ...
            <p className={'!text-3xl mt-5 flex text-cloudburst font-[800]'}>
                ...
                />
                <b className={'mr-3'}>%</b>
                Customer Satisfation Based
            </p>
            <MainDescription
                className={'!text-cloudburst !text-lg font-bold mt-2'}
                content={'If you have any questions or need help contact with our team, or call'}
            />
            <a
