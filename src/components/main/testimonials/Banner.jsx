...
const Banner = () => {
    return (
        <motion.div
            initial="hidden"
            whileInView="visible"
            className={'bg-butterscotch p-10'}
        >
            <MSubtitle
            ...
            <motion.p
                ...
                custom={2}
                className={'!text-3xl mt-5 flex text-cloudburst font-[800]'}
            >
                <AnimatedNumbers
                    includeComma
                    transitions={(index) => ({
                ...
                />
                <b className={'mr-3'}>%</b>
                Удовлетворение клинетов
            </motion.p>
            <MotionMainDescription
                variants={textRightAnimation}
                custom={3}
                className={'!text-cloudburst !text-lg font-bold mt-2'}
                content={'Если у вас есть какие-либо вопросы или вам нужна помощь, свяжитесь с нашей командой или позвоните по телефону:'}
            />
            {/*<a*/}
