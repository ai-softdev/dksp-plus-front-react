...
const Services = () => {
    const servicesList = [
        ...
        {
            svg: '/image/services/2.png',
            title: 'Electrical installation',
            description: 'Sagittis Nulla facilisi. In sed pretium metus. Proin pretium Turna sit amet tincidunt.'
        },
        {
            svg: '/image/services/3.png',
            title: 'General Builder',
            description: 'Sagittis Nulla facilisi. In sed pretium metus. Proin pretium Turna sit amet tincidunt.'
        },
        {
            svg: '/image/services/4.png',
            title: 'Security System',
            description: 'Sagittis Nulla facilisi. In sed pretium metus. Proin pretium Turna sit amet tincidunt.'
        },
        {
            svg: '/image/services/5.png',
            title: 'Service & maintenance',
            description: 'Sagittis Nulla facilisi. In sed pretium metus. Proin pretium Turna sit amet tincidunt.'
        },
        {
            svg: '/image/services/6.png',
