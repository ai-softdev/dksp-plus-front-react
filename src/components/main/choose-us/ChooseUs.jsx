    ...
    const chooseReasonList = [
        {
            ...
            subtitle: 'Pellentesque vehicula eros neque, maximus mattis est sagittis Nulla facilisi. In sed pretium '
        },
        {
